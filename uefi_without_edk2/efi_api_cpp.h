...
#ifndef EFI_API_CPP_H
#define EFI_API_CPP_H
...
#define PRINT(string) sys_table->con_out->output_string(sys_table->con_out, string);
...
struct efi_boot_services {
	...
	efi_status_t (EFIAPI *create_event)(u32 type,
...
#define EFI_NATIVE_INTERFACE	0x00000000
	...
	efi_status_t (EFIAPI *set_watchdog_timer)(unsigned long timeout,
			u64 watchdog_code, unsigned long data_size,
			u16 *watchdog_data);
...
#define EFI_OPEN_PROTOCOL_EXCLUSIVE           0x00000020
	...
	efi_status_t (EFIAPI *calculate_crc32)(void *data,
			unsigned long data_size, u32 *crc32);
	void (EFIAPI *copy_mem)(void *destination, const void *source,
			size_t length);
	void (EFIAPI *set_mem)(void *buffer, size_t size, u8 value);
...
struct efi_block_io {
	...
	efi_status_t (EFIAPI *reset)(struct efi_block_io *self,
			char extended_verification);
	efi_status_t (EFIAPI *read_blocks)(struct efi_block_io *self,
			u32 media_id, u64 lba, unsigned long buffer_size,
			void *buffer);
	efi_status_t (EFIAPI *write_blocks)(struct efi_block_io *self,
			u32 media_id, u64 lba, unsigned long buffer_size,
			void *buffer);
	efi_status_t (EFIAPI *flush_blocks)(struct efi_block_io *self);
};
...
struct efi_simple_input_interface {
	efi_status_t(EFIAPI *reset)(struct efi_simple_input_interface *self,
			bool ExtendedVerification);
	efi_status_t(EFIAPI *read_key_stroke)(
			struct efi_simple_input_interface *self,
...
struct efi_console_control_protocol
{
	efi_status_t (EFIAPI *get_mode)(
			struct efi_console_control_protocol *self, int *mode,
			char *uga_exists, char *std_in_locked);
	efi_status_t (EFIAPI *set_mode)(
			struct efi_console_control_protocol *self, int mode);
	efi_status_t (EFIAPI *lock_std_in)(
			struct efi_console_control_protocol *self,
			u16 *password);
};
...
{
	u16 *(EFIAPI *convert_device_node_to_text)(
			struct efi_device_path *device_node,
			bool display_only,
			bool allow_shortcuts);
	u16 *(EFIAPI *convert_device_path_to_text)(
			struct efi_device_path *device_path,
			bool display_only,
			bool allow_shortcuts);
};
...
struct efi_gop
{
	efi_status_t (EFIAPI *query_mode)(struct efi_gop *self, u32 mode_number,
					  efi_uintn_t *size_of_info,
					  struct efi_gop_mode_info **info);
	efi_status_t (EFIAPI *set_mode)(struct efi_gop *self, u32 mode_number);
	efi_status_t (EFIAPI *blt)(struct efi_gop *self, void *buffer,
...
{
	u64 revision;
	efi_status_t (EFIAPI *start)(struct efi_simple_network *self);
	efi_status_t (EFIAPI *stop)(struct efi_simple_network *self);
	efi_status_t (EFIAPI *initialize)(struct efi_simple_network *self,
			ulong extra_rx, ulong extra_tx);
	efi_status_t (EFIAPI *reset)(struct efi_simple_network *self,
			int extended_verification);
	efi_status_t (EFIAPI *shutdown)(struct efi_simple_network *self);
	efi_status_t (EFIAPI *receive_filters)(struct efi_simple_network *self,
			u32 enable, u32 disable, int reset_mcast_filter,
			ulong mcast_filter_count,
			struct efi_mac_address *mcast_filter);
	efi_status_t (EFIAPI *station_address)(struct efi_simple_network *self,
			int reset, struct efi_mac_address *new_mac);
	efi_status_t (EFIAPI *statistics)(struct efi_simple_network *self,
			int reset, ulong *stat_size, void *stat_table);
	efi_status_t (EFIAPI *mcastiptomac)(struct efi_simple_network *self,
			int ipv6, struct efi_ip_address *ip,
			struct efi_mac_address *mac);
	efi_status_t (EFIAPI *nvdata)(struct efi_simple_network *self,
			int read_write, ulong offset, ulong buffer_size,
			char *buffer);
	efi_status_t (EFIAPI *get_status)(struct efi_simple_network *self,
			u32 *int_status, void **txbuf);
	efi_status_t (EFIAPI *transmit)(struct efi_simple_network *self,
			size_t header_size, size_t buffer_size, void *buffer,
			struct efi_mac_address *src_addr,
			struct efi_mac_address *dest_addr, u16 *protocol);
	efi_status_t (EFIAPI *receive)(struct efi_simple_network *self,
			size_t *header_size, size_t *buffer_size, void *buffer,
			struct efi_mac_address *src_addr,
			struct efi_mac_address *dest_addr, u16 *protocol);
...
struct efi_file_handle {
	...
	efi_status_t (EFIAPI *del)(struct efi_file_handle *file);
...
struct efi_simple_file_system_protocol {
	u64 rev;
	efi_status_t (EFIAPI *open_volume)(struct efi_simple_file_system_protocol *self,
